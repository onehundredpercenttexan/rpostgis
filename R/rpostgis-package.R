...
##' R interface to a PostGIS-enable PostgreSQL database.
##'
##' This package provides functions to interface R with a PostGIS-enabled
##' database, as well as convenient wrappers to common PostgreSQL
##' queries. For a list of documented functions, 
##' use \code{library(help = "rpostgis")}.
##'
